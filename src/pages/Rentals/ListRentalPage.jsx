...
export default function ListRentalPage() {
  ...
  const handleSubmit = async () => {
    if (!agreed) { toast.error('Please agree to the listing terms'); return }
          ...
          <div className="mt-6">
            <div className="rounded-2xl border-2 p-4 transition-all cursor-pointer"
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold" style={{ color: '#1A1210' }}>I agree to DealMatch Listing Terms</p>
                  <p className="text-xs mt-1 leading-relaxed" style={{ color: '#8A7E78' }}>
                    ...
                    <a href="/terms" target="_blank" className="underline" style={{ color: '#C96A3A' }}>Terms of Service</a>.
                  </p>
                </div>
              </div>
            </div>
